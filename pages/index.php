...
<div id="shops">
    ...
    <div class="row g-4">
        <?php foreach ($shops as $shop): ?>
            <div class="col-md-4">
                <div class="card border-0 shadow-sm overflow-hidden" style="transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                    <div style="background: linear-gradient(135deg, #C4511A 0%, #FFB4B4 100%); height: 150px; display: flex; align-items: center; justify-content: center; font-size: 3rem;">
                    ...
                    <div class="card-footer bg-white border-0">
                         <a href="shops.php?id=<?php echo $shop['id']; ?>" class="btn btn-dark w-100 fw-bold"> BROWSE PRODUCTS → </a> </div>
                </div>
            </div> <?php endforeach; ?>
    </div>
</div>
